...
public class DeliveryRegistration2 {
    ...
    private static VBox createHeading() {
        ...
        Text description =
                new Text(
                        ...
                        + "Upload your documents for admin approval and set up your "
    ...
    private static VBox createSubmissionSection() {
        ...
        termsCheckbox =
                new CheckBox(
                        "I agree to the Terms & Conditions and Privacy Policy. "
                                + "I declare that all uploaded government identity "
                                + "documents and vehicle information are authentic."
                );

        termsCheckbox.setWrapText(
                true
        );

        termsCheckbox.setMaxWidth(
                1000
        );
        ...
        registerButton.setOnAction(e -> {
            ...
            PartnerConstants.ID_CARD_URL =
                    idUrl;

            PartnerConstants.LICENSE_DOC_URL =
                    dlUrl;

            PartnerConstants.RC_BOOK_URL =
                    rcUrl;

            if (PartnerConstants.ACCOUNT_NUMBER.length()
                    >= 4) {
